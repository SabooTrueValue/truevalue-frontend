      ...
      <div className="relative overflow-visible select-none ">
        ...
        >
          ...
          <div className="absolute z-10 justify-between  w-full gap-4 flex top-[43%]   ">
            ...
            >
              <BsArrowLeft className="text-2xl duration-500 translate-x-4 text-primary group-hover:text-white group-hover:translate-x-0 xl:text-3xl" />
            </div>
            ...
            >
              <BsArrowLeft className="text-2xl duration-500 rotate-180 -translate-x-4 text-primary group-hover:translate-x-0 xl:text-3xl group-hover:text-white" />
            </div>
          </div>
          <div className="px-2 overflow-hidden">
            {finalData.slice(0, 11).map((x, i) => {
              return (
...
function LimitedEditonCarSlider2() {
  const navigationPrevRef = useRef(null);
  const navigationNextRef = useRef(null);
